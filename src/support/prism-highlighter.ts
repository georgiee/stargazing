...
export class PrismLineHighlighter {
  ...
  constructor(
    ...
    this._slideBuilder = createSliderBuilder(this.slide!, () => this.previous(), ownFragmentIndex)
    this._slideBuilder.shown((direction: number) => (direction))
  }
  ...
  init() {
    ...
    this._slideBuilder.init(fragmentList)
  }
...
function createFragments({repeat, callback}: any) {
